...
@Component
 public class Menu extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("menu");
	...
	public Menu(String id) {this.setId(id);}
	...
	public  Class<?> getResultClass() {return MenuResult.class;};
	public  Class<?> getMessageClass() {return MenuMessage.class;};
	public  Class<?> getHelperClass() {return MenuHelper.class;};
	public  Class<?> getServiceClass() {return MenuService.class;};
}