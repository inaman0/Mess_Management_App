 ...
 */
@Component
 public class Dish extends BaseResource {
	...
	public static String FIELD_DISH_TYPE = "Dish_type";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("dish");
	...
	static {
		...
		Field Dish_typeField = new Field("Dish_type", "String");
		Dish_typeField.setEnum(true);
		Dish_typeField.setPossible_value("Dish_type");
		Dish_typeField.setRequired(true);
		metaData.addField(Dish_typeField);
		...
		metaData.setTableName("dish");

		metaData.setCluster("traveler_db");
	}

	public Dish() {this.setId(Util.getUniqueId());}
	public Dish(String id) {this.setId(id);}

	public Dish(Dish obj) {
		this.id = obj.id;
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		Dish_type = (String) map.get("Dish_type");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object Dish_typeObj = map.get("Dish_type");
		if(Dish_typeObj != null)
			Dish_type = Dish_typeObj.toString();
	...
	public String getDish_typeEx() {
		return Dish_type != null ? Dish_type : "";
	}
	...
	public void unSetDish_type() {
		this.Dish_type = null;
	}

	public boolean validateDish_type(boolean add) throws ApplicationException {
		if(add && Dish_type == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[Dish_type]");
		return Dish_type != null;
	}
	...
	public  Class<?> getResultClass() {return DishResult.class;};
	public  Class<?> getMessageClass() {return DishMessage.class;};
	public  Class<?> getHelperClass() {return DishHelper.class;};
	public  Class<?> getServiceClass() {return DishService.class;};
}