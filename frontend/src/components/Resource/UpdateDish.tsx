...
export type ResourceMetaData = {
  ...
  const apiUrl = `${apiConfig.getResourceUrl('dish')}?`
  const metadataUrl = `${apiConfig.getResourceMetaDataUrl('Dish')}?`
  ...
  const regex = /^(g_|archived|extra_data)/;
   ...
   const [currentUrl, setCurrentUrl] = useState('');
    ...
    navigate('/edit',{state:{id:id,editedData:editedData,resourceName:'Dish',currUrl:currentUrl,apiUrl:apiUrl.toString(),metadataUrl:metadataUrl.toString(),BaseUrl:BaseUrl.toString()}});
};
