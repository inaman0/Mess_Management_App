...
export type ResourceMetaData = {
  ...
  const regex = /^(g_|archived|extra_data)/;
   ...
   const [currentUrl, setCurrentUrl] = useState('');
    ...
    navigate('/edit',{state:{id:id,editedData:editedData,resourceName:'Menu',currUrl:currentUrl,apiUrl:apiUrl.toString(),metadataUrl:metadataUrl.toString(),BaseUrl:BaseUrl.toString()}});
};
